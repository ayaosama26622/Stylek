                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListenableBuilder(
                          ...
                          builder: (context, _) {
                            final isFavorite = FavoriteIdsController.instance
                                .isFavorite(favoriteKeyFor(_product));
                            return _ProductTitleRow(
                        ...
                        ListenableBuilder(
                          ...
                          builder: (context, _) {
                            final isInCart = CartIdsController.instance
                                .isInCart(cartKeyFor(_product));
                            return _CartQuantityRow(
                              quantity: _quantity,
                              isInCart: isInCart,
                              onAddToCart: () async {
                                try {
                              ...
                              onRemoveFromCart: () async {
                                try {
                                  await _detailsCubit.removeFromCart(
                                    _product,
                                  );
                                  if (context.mounted) {
                                    showSuccessSnackBar(
                                      context,
                                      'common.removed_from_cart'.tr(),
                                    );
                                  }
                                } catch (error) {
                                  if (context.mounted) {
